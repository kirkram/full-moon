...
/*   Updated: 2024/08/29 11:23:19 by klukiano         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				create_node_list(int capacity, t_astar *context,
						t_data *data);
...
void				pq_push(t_priorityqueue *pq, t_node *node, t_astar *context,
						t_data *data);
t_node				*pq_pop(t_priorityqueue *pq, t_astar *context,
						t_data *data);
...
// void 			error_init_closed_set(t_astar *context, t_data *data,
				// int **closed_set);
